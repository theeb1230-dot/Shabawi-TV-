...
|yt-info|main|825fa28ad1a0e877e5a5123e2ba30a967586d26e|286e54f3f4020c810437908a56e608ab024a2854|11|11|0|FULL|
...
- New continuation start main: `17a0bfb9fce3ddcab002cc1070df9cfc7fd2de1c`; account discovery remains 49 and destination admin/push permission is confirmed.
- Closed `yt-info` FULL 11/11 at exact commit `825fa28ad1a0e877e5a5123e2ba30a967586d26e`, tree `286e54f3f4020c810437908a56e608ab024a2854`: identified the missing 11th blob as `README.md` and mirrored it byte-exact (`df8f50a2e629abc132af04f756b2ec214db00248`). Re-audit also found destination `src/types.ts` had the wrong blob; it was corrected to upstream blob `db49576bf0b31cda9dbdff48d58d0cbaa435e0b7`. FULL is claimed only after correcting that drift.
...
- Raw Mirror Completeness: **not yet promoted to a project-wide percentage** because a fresh expected-blob denominator for all 49 is still incomplete. In the strict verified subset, **46/206 blobs are byte-exact = 22.3%**, with **29 BLOCKED** and **131** other missing/PARTIAL. Three newly mirrored one-blob repositories are content-complete but are not yet credited to strict Inventory Coverage because their exact tree SHA still needs independent capture. This subset ratio is evidence, not the project-wide ratio.
