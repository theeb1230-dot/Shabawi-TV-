...
|11|TVnai|f94799737839abbd580476237d1c2192f3b3b256|README only|Historical classification only|Yes (FULL: 1/1)|
...
|15|my-project|d604fb35a7d36f3dc4184d3bab29f73b6f8b000a|Devcontainer + README|Historical classification only|Yes (FULL: 2/2)|
...
|17|Play|5f592d62b079d6335f3ce0db8b60bfd02c77e2b3|Static player/test HTML|REVIEW|Yes|
...
|23|video-player|4b7668389372d3277ccb35f5defd5627d046c099|Capacitor/Android + HTML player + workflow|REVIEW|Yes|
|24|TVNAI3|f92e8cccef53df3c712ae2848b0deec9c2734265|README only|Historical classification only|Yes (FULL: 1/1)|
|25|yt-extract-cli|b0244b3f6c4c2d4da505fa54aed42b1f197615ac|TypeScript extraction CLI|OPTIONAL tooling|Yes|
|26|video.plyr.io|c6f2220f2549c7f213065c9561e1bd8af3e9d35d|Android WebView HLS/Plyr/Shaka + workflow|KEEP reference|Yes|
|27|TVNAI2|5a74aaa0a7985b8a12e68460164f9bd86e8bbb92|Small HTML/CSS/JS UI|REVIEW UI|Yes|
|28|Plyr.io|81432335b1b53fa0d6677f25be89c04623507a5a|Android Kotlin Plyr shell + workflow|REVIEW|Yes|
...
|31|plyr|27765233549c82c86ae82a08e48664cec373c704|Android Kotlin player shell + workflow|REVIEW|Yes|
|32|NETFLIX|ca734f4ebb0cfcd5732c06257b1281c9a5fd0153|Static Netflix-style UI|UI reference|Yes|
...
|35|KickStream-Actions-Orchestrator|05d9ceb500279fe82723aed6e2a3a95d6f0fd7ba|GitHub Actions stream orchestrator|OPTIONAL live|Yes|
|36|TV|3f6d22e45d1cff251166e83fc7089a9e3fb5bdf6|README only|Historical classification only|Yes (FULL: 1/1)|
|37|faselhd-db|8720db9526c02b879aa9a6b916c814a5dd88ef93|FaselHD/TopCinma/Ostora indexer, snapshots, Supabase sync, tests/workflow|KEEP CRITICAL|Yes|
...
|41|Netflix.github.io|c908d73092fc779d43afebe35a821a48a3eb7a1e|README only|Historical classification only|Yes (FULL: 1/1)|
...
## Next mirror batch
1. Close the remaining smallest non-empty unrepresented repositories first, then medium repositories, while preserving exact paths and SHAs.
2. Re-sync `faselhd-db` from current tree `8720db9526c02b879aa9a6b916c814a5dd88ef93`; its prior inventory SHA drifted.
3. Compute expected/transferred/missing blob counts for every repository before assigning FULL.
4. Do not begin Shabawi-owned integration until raw mirror/provenance completeness is established.