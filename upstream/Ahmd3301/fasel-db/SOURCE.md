...
Transferred byte-exact upstream blobs: 8
Missing upstream blobs: 19
...
Verified transferred paths in this run:
- data/anime.json
- data/anime_movies.json
- data/asian_movies.json
- data/asian_series.json
- data/hindi.json
- data/movies.json
- data/series.json
- data/tvshows.json

All eight paths use upstream blob SHA `0637a088a01e8ddab3bf3fa98dbe804cbde1a0dc` and contain the exact upstream bytes `[]`.
